...
##### **[ 개요 ]** #####
    ...
    - 모델 실행 결과를 수동으로 관리해야하는 경우 사용합니다. 
...
##### 1) python 실행 후 model_run_DB Import #####

![수동-1](https://user-images.githubusercontent.com/104196127/165683909-251ca8ca-3a3a-4177-a2e5-e993fa3178dd.jpg)
